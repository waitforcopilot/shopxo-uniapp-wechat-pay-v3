    ...
    export default {
        globalData: {
            data: {
                // 基础配置
                // 数据接口请求地址
                request_url:'https://nsr5.itmacode.cn/',

                // 静态资源地址（如系统根目录不在public目录下面请在静态地址后面加public目录、如：https://nsr.itmacode.cn/public/）
                static_url:'https://nsr5.itmacode.cn/public/',

                // 系统类型（默认default、如额外独立小程序、可与程序分身插件实现不同主体小程序及支付独立）
                system_type: 'default',

                // 基础信息
                application_title: 'St.Rols全球购',
                application_describe: '美妆护肤品跨境销售，货品来自韩国香港免税店及品牌方直采',
